...
<div class="hero min-h-screen bg-base-200">
  <div class="hero-content flex-col lg:flex-row-reverse">
    <div class="text-center lg:text-left">
      <h1 class="text-5xl font-bold">Đăng_ký_thành_viên!</h1>
      <p class="py-6">Đăng ký ngay và luôn!</p>
    </div>
    <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      <div class="card-body">
        ...
        <div class="form-control">
          ...
          <input type="email" class="input input-bordered" name="email" value="" required />
        </div>
        <div class="form-control">
          <label class="label">
            <span class="label-text">Phone number</span>
          </label>
          <input type="text" class="input input-bordered" name="phone" value="" required />
        </div>
        <div class="form-control">
          <label class="label">
